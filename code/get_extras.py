...
def best_dressed(tweets):
    ...
    best_dressed = np.array(clean2(best_dressed, ['rt', '@', 'golden', 'globe', 'goldenglobe', 'award', '#', 'best', 'red carpet','damn','eredcarpet','redcarpet']))
...
def worst_dressed(tweets):
    ...
    worst_dressed = np.array(clean2(worst_dressed, ['rt', 'best','photos','see', 'course', 'who','stars', '@', 'golden', 'globe', 'award', 'goldenglobe' '#', 'worst', 'wtf', 'red carpet','damn','eredcarpet','redcarpet']))
...
def most_discussed(tweets):
    ...
    most_discussed = np.array(clean2(most_discussed, ['rt', '@', 'golden', 'globe', 'award', 'goldenglobe', '#', 'worst', 'redcarpet','eredcarpet','red carpet','red']))
